...
const howItWorksSeed: TrustSeed = {
  ...
  kk: {
    ...
    meta:
      "Vitrina AI Studio қалай жұмыс істейді: Kaspi сатушыларына тауар фотосы workflow, қолмен QA, модерация кепілдемейді.",
    intro:
      "Vitrina AI Studio Қазақстандағы Kaspi және басқа маркетплейс сатушыларына тауар фотосын дайындауға көмектеседі: ақ фон карточкасы, фонды тазалау, модельде киім. Бастапқы фото жүктеледі, сценарий таңдалады, нәтиже мониторда тексеріледі — содан кейін ғана кабинетке жүктейсіз. Сервис ресми Kaspi серіктесі емес.",
  },
  sectionsRu: [
    {
  ...
  sectionsKk: [
    {
      ...
      body:
        "Смартфонмен түсірілген анық бастапқы фото жиі жеткілікті. Тауар кадрдың көп бөлігін алсын, жарық біркелкі болсын. Киім үшін алдыңғы ракурс; артқы көрініс — сәйкес бұрыштағы исходник.",
    },
    {
      title: "2-қадам. Тапсырманы таңдау",
      body:
        "Нақты тауар карточкасы, модельде киім, фонды алу немесе ауыстыру. Видео және Reels сценарийлері әзірленуде — қолжетімді болмаса, тек тексерілген статиканы жариялаңыз.",
    },
    {
      title: "3-қадам. Стиль мен формат",
      body:
        "Kaspi кабинетіндегі ағымдағы анықтамаға сәйкес 1:1, 4:5 немесе 9:16 таңдаңыз. Негізгі кадр мен галерея бір түсті, бір жинақты көрсетуі керек.",
    },
    {
      title: "4-қадам. Нәтижені тексеру",
      body:
        "Түс, пішін, принт, тігіс, фурнитура, логотиптер — бастапқымен салыстырыңыз. AI детальды өзгертуі мүмкін; күмәнді кадрды жарияламаңыз.",
    },
    {
      title: "5-қадам. Kaspi және басқа арналарға жариялау",
      body:
        "Экспорттаған файлды кабинетке жүктемес бұрын миниатюрада оқылатынын тексеріңіз. Wildberries және Ozon үшін де сол SKU-ға сәйкестікті растаңыз.",
    },
    {
      title: "Кімге арналған",
      body:
        "Kaspi сатушылары, маркетплейс контент-менеджерлері, интернет-дүкендер, SMM және фотосуретшісіз жаңартатын каталог.",
    },
    {
      title: "AI кепілдемейді",
      body:
        "Идеалды көшірме, автоматты модерация, Kaspi/Wildberries/Ozon ресми серіктестігі. Жауапкершілік сатушыда.",
    },
  ],
  faqRu: [
    {
...
const qualitySeed: TrustSeed = {
  ...
  kk: {
    ...
    meta:
      "AI тауар фотосының шектеулері: Kaspi сатушыларына жарияламас бұрын тексеру, маркетплейс ережелері — ресми Kaspi серіктесі емес.",
    intro:
      "AI контентті жеделдетеді, бірақ сатушының жауапкершілігін алмайды. Бетте қателер, тексеру тізімі, Kaspi/Wildberries/Ozon шекаралары және сервис уәделерінің шегі көрсетілген.",
  },
  sectionsRu: [
    {
  ...
  sectionsKk: [
    {
      ...
      body:
        "Түс, пішін, принт, тігіс, тастар, логотиптер өзгеруі немесе артық деталь қосылуы мүмкін. Кружево, әшекей, қара маталарда тәуекел жоғары.",
    },
    {
      title: "Жарияламас бұрын",
      body:
        "Бастапқымен мониторда салыстырыңыз; даулы SKU-да әріптестен пікір алыңыз. Қабылданбаған кадр себебін жазып, келесі жүктемені жақсартыңыз.",
    },
    {
      title: "Жақсы нәтиже",
      body:
        "Таза фото, тауарды жаппау, front/back бұрыш, дұрыс студия тапсырмасы, фон алғаннан кейін крайларды тексеру.",
    },
    {
      title: "Маркетплейстер",
      body:
        "Kaspi, Wildberries, Ozon ережелері өзгереді. Vitrina AI модерацияны кепілдемейді және ресми серіктес емес.",
    },
    {
      title: "Уәде етпейміз",
      body:
        "100% дәл көшірме, автоматты карточка мақұлдауы, заңды сату кепілдігі, әр категорияда кәсіби фотосессияны алмастыру.",
    },
    {
      title: "Іш киім",
      body:
        "Тек ересек коммерциялық каталог; несие балаларды сексуализациялауға болмайды. Площадка ережелері мен заңды сақтаңыз.",
    },
  ],
  faqRu: [
    {
...
const faqSeed: TrustSeed = {
  ...
  kk: {
    ...
    meta:
      "Vitrina AI Studio FAQ: Kaspi сатушыларына модельде киім, фон, іш киім, баға, AI нәтижені тексеру — ресми Kaspi серіктесі емес.",
    intro:
      "Қазақстандағы Kaspi және маркетплейс сатушыларының жиі сұрақтары. Толық нұсқаулықтар блогта және сценарий беттерінде; жарияламас бұрын әр нәтижені тексеріңіз.",
  },
  sectionsRu: [
    {
  ...
  sectionsKk: [
    {
      ...
      body:
        "Тауар фотосы мен визуалды дайындауға арналған онлайн-студия: карточка, фон, AI модельде киім — жарияламас бұрын қолмен QA.",
    },
    {
      title: "Қанша тұрады?",
      body:
        "Демо-режимде төлем жоқ. Төлемді тарифтер мен генерация бағасы /kk/cost бетінде; billing іске қосылғанша өзгеруі мүмкін.",
    },
  ],
  faqRu: [
    {
        ...
        if (locale === "kk" && seed.kk && seed.sectionsKk && seed.faqKk) {
          return [
            locale,
            {
              ...
              status: (isKkTrustPageApproved(seed.key)
                ? "published"
